                  ...
                  return (
                    <motion.button
                      ...
                      className={
                        ...
                        (active
                          ? "border-accent bg-accent text-[#0B0B0B] shadow-[0_8px_20px_-10px_rgba(255,176,32,0.5)]"
          ...
          return (
            <button
              ...
              className={
                ...
                (active
                  ? "bg-accent text-[#0B0B0B] font-semibold shadow-[0_8px_20px_-10px_rgba(255,176,32,0.5)]"
                  : available && inRange
    ...
    >
      {service && slot && (
        <div className="flex items-center gap-2.5 rounded-xl bg-accent/10 border border-accent/20 px-3 py-2.5">
          <span className="bg-accent inline-flex items-center justify-center size-[32px] rounded-lg text-[#0B0B0B] shrink-0">
            <svg
              width="15"
              height="15"
              viewBox="0 0 24 24"
        ...
        <div className="lg:col-span-2">
          ...
          >
            <textarea
              ...
              rows={3}
              className="w-full px-4 py-3 rounded-sm border border-line bg-soft focus:border-accent focus:ring-2 focus:ring-accent/20 outline-none transition-all text-[14px] text-ink resize-none"
            />
          </Field>
        </div>
      </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center gap-4 py-2 flex-1">
      <motion.div
        ...
        className="bg-accent size-[68px] rounded-full flex items-center justify-center text-[#0B0B0B] shadow-[0_18px_40px_-12px_rgba(255,176,32,0.45)]"
      >
        <motion.svg
...
function Input({
  ...
  return (
    <input
      {...props}
      className={
        "w-full h-[46px] px-4 rounded-sm border focus:ring-2 outline-none transition-all text-[14px] text-ink bg-soft " +
        (error
